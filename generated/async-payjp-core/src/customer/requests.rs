...
impl ListCustomer {
    ...
    pub fn paginate(
        &self,
    ) -> payjp_client_core::ListPaginator<stripe_types::List<stripe_shared::Customer>> {
...
impl BalanceTransactionsCustomer {
    ...
    pub fn paginate(
        &self,
    ) -> payjp_client_core::ListPaginator<
        stripe_types::List<stripe_shared::CustomerBalanceTransaction>,
    > {
        let customer = &self.customer;

        payjp_client_core::ListPaginator::new_list(
...
impl ListPaymentMethodsCustomer {
    ...
    pub fn paginate(
        &self,
    ) -> payjp_client_core::ListPaginator<stripe_types::List<stripe_shared::PaymentMethod>> {
        let customer = &self.customer;
