...
use payjp_client_core::{CustomizedStripeRequest, RequestBuilder, StripeMethod};
                        ...
                        last_error = from_str(str)
                            ...
                            .unwrap_or_else(|_| {
                                StripeError::JSONDeserialize(
                                    "error deserializing Stripe error by hyper".into(),
                                )
                            });
...
impl payjp_client_core::StripeClient for Client {
